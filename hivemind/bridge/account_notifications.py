...
if __name__ == "__main__":
  ...
  parser.add_argument("limit", type = int, help = "Limit of notifications to show")
  ...
  print("Account name: {}".format(args.name))
  print("Account limit: {}".format(args.limit))
