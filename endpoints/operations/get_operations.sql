...
BEGIN
  PERFORM hafah_backend.validate_limit("page-size", 150000, 'page-size');
  PERFORM hafah_backend.validate_negative_limit("page-size", 'page-size');
  PERFORM hafah_backend.validate_block_range( _block_range.first_block, _block_range.last_block + 1, 2001);
