...
using transaction_controllers::transaction_controller;
using transaction_controllers::transaction_controller_ptr;
...
class ah_loader
{
  ...
  public:
    ...
    void init( const args_container& _args )
    {
      ...
      {
        tx_controllers.emplace_back( transaction_controllers::build_own_transaction_controller( args.url, "ah_loader instance" ) );
      }
    }
