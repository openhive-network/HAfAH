...
OPERATIONS_COUNT = 107
TRANSACTIONS_COUNT = 107
TRANSACTIONS_MULTISIG_COUNT = 0
ACCOUNTS_COUNT = 92_462
ACCOUNT_OPERATIONS_COUNT = 141


def test_replay_body_operations_filtered_5milion():
    logger.info(f'Start test_replay_body_operations_filtered_5milion')
