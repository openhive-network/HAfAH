...
BEGIN
    ...
    ASSERT EXISTS ( SELECT FROM hive.shadow_public_table1 hs WHERE hs.id = 123 AND hs.smth='balbla' AND hive_block_num = 3 AND hive_operation_type = 'DELETE' ), 'Wrong block num';
END
$BODY$
;
