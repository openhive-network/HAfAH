...
BEGIN
    ...
    ASSERT EXISTS ( SELECT FROM hive.shadow_a_table1 hs WHERE hs.id = 123 AND hs.smth = 'blabla1' AND hive_operation_type = 0 ), 'Wrong operation type table1';
    ...
    ASSERT EXISTS ( SELECT FROM hive.shadow_a_table2 hs WHERE hs.id = 223 AND hs.smth = 'blabla2' AND hive_operation_type = 0 ), 'Wrong operation type table2';
    ...
    ASSERT EXISTS ( SELECT FROM hive.shadow_public_table3 hs WHERE hs.id = 323 AND hs.smth = 'blabla3' AND hive_operation_type = 0 ), 'Wrong operation type table3';
