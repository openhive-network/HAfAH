...
BEGIN
    ...
    ASSERT EXISTS ( SELECT FROM hive.shadow_a_table1 hs WHERE hs.id = 123 AND hs.smth = 'blabla' AND hive_block_num = 3 AND hive_operation_type = 'UPDATE' ), 'No expected row';
END
$BODY$
;
