...
BEGIN
    ...
    ASSERT ( SELECT events_id FROM hive.context WHERE name='context' ) = 4, 'Wrong events id';
    ASSERT ( SELECT irreversible_block FROM hive.context WHERE name='context' ) = 6, 'Wrong irreversible';
