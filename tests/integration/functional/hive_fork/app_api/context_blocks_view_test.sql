...
BEGIN
    ...
    UPDATE hive.app_context SET fork_id = 2, irreversible_block = 4;
END;
$BODY$
;
...
BEGIN
    ...
    -- ( 5, '\xBADD5A', '\xCAFE5A', '2016-06-22 19:10:25-07'::timestamp )
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
                 ...
                 , (9, '\xBADD90'::bytea, '\xCAFE90'::bytea, '2016-06-22 19:10:29-07'::timestamp)
                  ) as pattern
