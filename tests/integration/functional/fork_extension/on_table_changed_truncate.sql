...
BEGIN
    ...
    DROP TRIGGER IF EXISTS on_src_table1_change_truncate on table1;
    CREATE TRIGGER on_src_table1_change_truncate BEFORE TRUNCATE ON table1
...
BEGIN
    ...
    ASSERT ( SELECT COUNT(*) FROM hive_tuples WHERE operation = 2 ) = 2, 'TEST FAILED';
END
$BODY$
;
