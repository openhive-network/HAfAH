...
$BODY$
BEGIN
  ASSERT (select '{"type":"system_warning_operation","value":{"message":""}}'::jsonb::hive.operation::text = '\x5200');

  ASSERT (select '{"type":"system_warning_operation","value":{"message":"abc"}}'::jsonb::hive.operation::text = '\x5203616263');

  ASSERT (select '{"type":"limit_order_cancel_operation","value":{"owner":"complexring","orderid":4294967295}}'::jsonb::hive.operation::text = '\x060b636f6d706c657872696e67ffffffff');

  ASSERT (select '{"type":"system_warning_operation","value":{"message":"no impacted accounts"}}'::jsonb::hive.operation::text = '\x52146e6f20696d706163746564206163636f756e7473');
