...
BEGIN
  ...
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(vote_operation))->0)::VARCHAR = '"vote"', 'operation "vote_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(comment_operation))->0)::VARCHAR = '"comment"', 'operation "comment_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(transfer_operation))->0)::VARCHAR = '"transfer"', 'operation "transfer_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(transfer_to_vesting_operation))->0)::VARCHAR = '"transfer_to_vesting"', 'operation "transfer_to_vesting_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(withdraw_vesting_operation))->0)::VARCHAR = '"withdraw_vesting"', 'operation "withdraw_vesting_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(limit_order_create_operation))->0)::VARCHAR = '"limit_order_create"', 'operation "limit_order_create_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(limit_order_cancel_operation))->0)::VARCHAR = '"limit_order_cancel"', 'operation "limit_order_cancel_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(feed_publish_operation))->0)::VARCHAR = '"feed_publish"', 'operation "feed_publish_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(convert_operation))->0)::VARCHAR = '"convert"', 'operation "convert_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(account_create_operation))->0)::VARCHAR = '"account_create"', 'operation "account_create_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(account_update_operation))->0)::VARCHAR = '"account_update"', 'operation "account_update_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(witness_update_operation))->0)::VARCHAR = '"witness_update"', 'operation "witness_update_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(account_witness_vote_operation))->0)::VARCHAR = '"account_witness_vote"', 'operation "account_witness_vote_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(account_witness_proxy_operation))->0)::VARCHAR = '"account_witness_proxy"', 'operation "account_witness_proxy_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(pow_operation))->0)::VARCHAR = '"pow"', 'operation "pow_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(custom_operation))->0)::VARCHAR = '"custom"', 'operation "custom_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(delete_comment_operation))->0)::VARCHAR = '"delete_comment"', 'operation "delete_comment_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(custom_json_operation))->0)::VARCHAR = '"custom_json"', 'operation "custom_json_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(comment_options_operation))->0)::VARCHAR = '"comment_options"', 'operation "comment_options_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(set_withdraw_vesting_route_operation))->0)::VARCHAR = '"set_withdraw_vesting_route"', 'operation "set_withdraw_vesting_route_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(request_account_recovery_operation))->0)::VARCHAR = '"request_account_recovery"', 'operation "request_account_recovery_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(recover_account_operation))->0)::VARCHAR = '"recover_account"', 'operation "recover_account_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(change_recovery_account_operation))->0)::VARCHAR = '"change_recovery_account"', 'operation "change_recovery_account_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(pow2_operation))->0)::VARCHAR = '"pow2"', 'operation "pow2_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(fill_convert_request_operation))->0)::VARCHAR = '"fill_convert_request"', 'operation "fill_convert_request_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(author_reward_operation))->0)::VARCHAR = '"author_reward"', 'operation "author_reward_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(curation_reward_operation))->0)::VARCHAR = '"curation_reward"', 'operation "curation_reward_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(comment_reward_operation))->0)::VARCHAR = '"comment_reward"', 'operation "comment_reward_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(liquidity_reward_operation))->0)::VARCHAR = '"liquidity_reward"', 'operation "liquidity_reward_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(interest_operation))->0)::VARCHAR = '"interest"', 'operation "interest_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(fill_vesting_withdraw_operation))->0)::VARCHAR = '"fill_vesting_withdraw"', 'operation "fill_vesting_withdraw_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(fill_order_operation))->0)::VARCHAR = '"fill_order"', 'operation "fill_order_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(hardfork_operation))->0)::VARCHAR = '"hardfork"', 'operation "hardfork_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(comment_payout_update_operation))->0)::VARCHAR = '"comment_payout_update"', 'operation "comment_payout_update_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(producer_reward_operation))->0)::VARCHAR = '"producer_reward"', 'operation "producer_reward_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(effective_comment_vote_operation))->0)::VARCHAR = '"effective_comment_vote"', 'operation "effective_comment_vote_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(ineffective_delete_comment_operation))->0)::VARCHAR = '"ineffective_delete_comment"', 'operation "ineffective_delete_comment_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(changed_recovery_account_operation))->0)::VARCHAR = '"changed_recovery_account"', 'operation "changed_recovery_account_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(transfer_to_vesting_completed_operation))->0)::VARCHAR = '"transfer_to_vesting_completed"', 'operation "transfer_to_vesting_completed_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(pow_reward_operation))->0)::VARCHAR = '"pow_reward"', 'operation "pow_reward_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(vesting_shares_split_operation))->0)::VARCHAR = '"vesting_shares_split"', 'operation "vesting_shares_split_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(account_created_operation))->0)::VARCHAR = '"account_created"', 'operation "account_created_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(system_warning_operation))->0)::VARCHAR = '"system_warning"', 'operation "system_warning_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(limit_order_create2_operation))->0)::VARCHAR = '"limit_order_create2"', 'operation "limit_order_create2_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(claim_account_operation))->0)::VARCHAR = '"claim_account"', 'operation "claim_account_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(create_claimed_account_operation))->0)::VARCHAR = '"create_claimed_account"', 'operation "create_claimed_account_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(escrow_transfer_operation))->0)::VARCHAR = '"escrow_transfer"', 'operation "escrow_transfer_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(escrow_dispute_operation))->0)::VARCHAR = '"escrow_dispute"', 'operation "escrow_dispute_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(escrow_release_operation))->0)::VARCHAR = '"escrow_release"', 'operation "escrow_release_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(escrow_approve_operation))->0)::VARCHAR = '"escrow_approve"', 'operation "escrow_approve_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(transfer_to_savings_operation))->0)::VARCHAR = '"transfer_to_savings"', 'operation "transfer_to_savings_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(transfer_from_savings_operation))->0)::VARCHAR = '"transfer_from_savings"', 'operation "transfer_from_savings_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(cancel_transfer_from_savings_operation))->0)::VARCHAR = '"cancel_transfer_from_savings"', 'operation "cancel_transfer_from_savings_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(decline_voting_rights_operation))->0)::VARCHAR = '"decline_voting_rights"', 'operation "decline_voting_rights_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(claim_reward_balance_operation))->0)::VARCHAR = '"claim_reward_balance"', 'operation "claim_reward_balance_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(delegate_vesting_shares_operation))->0)::VARCHAR = '"delegate_vesting_shares"', 'operation "delegate_vesting_shares_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(account_create_with_delegation_operation))->0)::VARCHAR = '"account_create_with_delegation"', 'operation "account_create_with_delegation_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(witness_set_properties_operation))->0)::VARCHAR = '"witness_set_properties"', 'operation "witness_set_properties_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(account_update2_operation))->0)::VARCHAR = '"account_update2"', 'operation "account_update2_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(create_proposal_operation))->0)::VARCHAR = '"create_proposal"', 'operation "create_proposal_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(update_proposal_votes_operation))->0)::VARCHAR = '"update_proposal_votes"', 'operation "update_proposal_votes_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(remove_proposal_operation))->0)::VARCHAR = '"remove_proposal"', 'operation "remove_proposal_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(update_proposal_operation))->0)::VARCHAR = '"update_proposal"', 'operation "update_proposal_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(collateralized_convert_operation))->0)::VARCHAR = '"collateralized_convert"', 'operation "collateralized_convert_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(recurrent_transfer_operation))->0)::VARCHAR = '"recurrent_transfer"', 'operation "recurrent_transfer_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(shutdown_witness_operation))->0)::VARCHAR = '"shutdown_witness"', 'operation "shutdown_witness_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(fill_transfer_from_savings_operation))->0)::VARCHAR = '"fill_transfer_from_savings"', 'operation "fill_transfer_from_savings_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(return_vesting_delegation_operation))->0)::VARCHAR = '"return_vesting_delegation"', 'operation "return_vesting_delegation_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(comment_benefactor_reward_operation))->0)::VARCHAR = '"comment_benefactor_reward"', 'operation "comment_benefactor_reward_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(clear_null_account_balance_operation))->0)::VARCHAR = '"clear_null_account_balance"', 'operation "clear_null_account_balance_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(proposal_pay_operation))->0)::VARCHAR = '"proposal_pay"', 'operation "proposal_pay_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(sps_fund_operation))->0)::VARCHAR = '"sps_fund"', 'operation "sps_fund_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(hardfork_hive_operation))->0)::VARCHAR = '"hardfork_hive"', 'operation "hardfork_hive_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(hardfork_hive_restore_operation))->0)::VARCHAR = '"hardfork_hive_restore"', 'operation "hardfork_hive_restore_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(delayed_voting_operation))->0)::VARCHAR = '"delayed_voting"', 'operation "delayed_voting_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(consolidate_treasury_balance_operation))->0)::VARCHAR = '"consolidate_treasury_balance"', 'operation "consolidate_treasury_balance_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(sps_convert_operation))->0)::VARCHAR = '"sps_convert"', 'operation "sps_convert_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(fill_collateralized_convert_request_operation))->0)::VARCHAR = '"fill_collateralized_convert_request"', 'operation "fill_collateralized_convert_request_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(fill_recurrent_transfer_operation))->0)::VARCHAR = '"fill_recurrent_transfer"', 'operation "fill_recurrent_transfer_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(failed_recurrent_transfer_operation))->0)::VARCHAR = '"failed_recurrent_transfer"', 'operation "failed_recurrent_transfer_operation" error';
  ASSERT (SELECT(SELECT hive.get_legacy_style_operation(limit_order_cancelled_operation))->0)::VARCHAR = '"limit_order_cancelled"', 'operation "limit_order_cancelled_operation" error';
