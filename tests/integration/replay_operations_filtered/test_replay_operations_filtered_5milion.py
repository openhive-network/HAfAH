...
OPERATIONS_COUNT = 5_880_270
TRANSACTIONS_COUNT = 5_720_583
TRANSACTIONS_MULTISIG_COUNT = 4
ACCOUNTS_COUNT = 92_462
ACCOUNT_OPERATIONS_COUNT = 11_052_042


def test_replay_operations_filtered_5milion():
    logger.info(f'Start test_replay_operations_filtered_5milion')
