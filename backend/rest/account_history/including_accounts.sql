...
/*
 * including_accounts.sql: Account history filtering by multiple transacting accounts (include).
 *
 * Called by: hafah_backend.get_ops_by_account() in backend/rest/account_history/router.sql
 *
 * Used when: participation_mode='include' with multiple account filter
 */

/*
 * ===================================================================================
 * account_history_including_accounts
 * ===================================================================================
 * PURPOSE: Retrieve account operations where the transacting account matches any
 *          of the specified accounts. Uses a sliding window pagination approach with
 ...
 *   _transacting_account_ids - Array of account IDs that must be the transacting party
