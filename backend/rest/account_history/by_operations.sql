...
/*
 * by_operations.sql: Account history filtering by operation types.
 *
 * Called by: hafah_backend.get_ops_by_account() in backend/rest/account_history/router.sql
 *
 * Used when: Operation type filter is provided and no account filter
 */

/*
 * ===================================================================================
 * account_history_by_operations
 * ===================================================================================
 * PURPOSE: Retrieve account operations filtered by operation types. Returns operations
 *          matching the specified types within the given block range.
 *
 * PARAMETERS:
