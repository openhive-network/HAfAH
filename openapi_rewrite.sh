...
$endpoints_dir/block_api/get_block.sql
$endpoints_dir/block_api/get_block_range.sql
$endpoints_dir/block_api/get_block_header.sql
$endpoints_dir/account_history_api/get_ops_in_block.sql
$endpoints_dir/account_history_api/enum_virtual_ops.sql

$endpoints_dir/account_history_api/get_transaction.sql

$endpoints_dir/account_history_api/get_account_history.sql
